...
?>
       ...
       <?php
include('afficherpublication.php'); ?>
  <!-- // insérer le commentaire dans la base de données en utilisant $id et $commentaire -->
...
<a style="margin-top: 5px;" href="#" onclick="afficherBoiteCommentaire()"> 
  <img style="float: left;border: 0;height: 14px;margin: 0 5px -4px 0;width: 14px;display: inline;" src="images/commentaire.jpg">
  <div >commentaire</div>
</a>
</div>
<!-- Ajoutez un événement de clic à votre lien de commentaire en ajoutant l'attribut onclick -->
<script>

  function afficherBoiteCommentaire() {
  var commentaire = prompt("Entrez votre commentaire:");
  if (commentaire != null) {
...
<!-- Créez une fonction JavaScript afficherBoiteCommentaire() qui affichera une boîte de dialogue contenant un formulaire permettant à l'utilisateur d'insérer un commentaire. -->
...
<script>
  ...
  fetch('index.php', {
    method: 'POST',
    body: JSON.stringify({id: id, commentaire: commentaire})
  })
...
<!-- ajouterCommentaire() qui enverra le commentaire à la page index.php pour l'ajouter à la base de données -->
<script>
  function ajouterCommentaire(commentaire) {
  var id = <?php echo $id; ?>;
  fetch('index.php', {
